...
const VHPCaptcha: React.FC<VHPCaptchaProps> = ({
  ...
  const [mode, setMode] = useState<'initial' | 'challenge' | 'login' | 'success' | 'failed'>('initial');
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      >
        ...
        >
          {/* Initial State - Matches your design */}
          {mode === 'initial' && (
            <div className="w-full">
              ...
              <div className="flex gap-4 justify-center px-8">
                <ThematicContainer
                  ...
                  glassmorphic={false}
                  rounded="full"
                  className="w-[120px] py-2 text-center h-[48px] flex items-center"
